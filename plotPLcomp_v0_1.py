...
def plplot(x,xmin,alpha,mar):
    ...
    if f_dattype== 'REAL':
        ...
        h[0]=plt.loglog(c1, c2, mar,markersize=8,markerfacecolor=[1,1,1],markeredgecolor=[0,0,1])
        ...
        #h[0]=plt.loglog(c1, c2,'g*',markersize=8,markerfacecolor=[1,1,1],markeredgecolor=[0,0,1])
